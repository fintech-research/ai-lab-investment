...
| | Frontier Lab | Platform | Hyperscaler | Infra Provider |
|:--|:------------|:---------|:------------|:--------------|
| *Archetype* | Anthropic | OpenAI | Google | CoreWeave |
| Revenue '25 (\$B) | 3.0 | 12.0 | 55.0 | 5.0 |
...
**Single-firm** (H regime): $X^* \approx 0.49$, $K^* \approx 0.55$

**Duopoly equilibrium**:

- Follower: $X_F \approx 0.66$, $K_F \approx 0.42$
- Leader invests earlier via preemption: $X_P < X_F$
