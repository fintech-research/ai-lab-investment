...
<!-- Replace [bracketed] fields before each submission. Journal-specific fit
     paragraphs can be swapped in at the marked spot. Target ladder is in
     submission/README.md. -->

Dear [Professor Editor-in-Chief name],

I am pleased to submit my manuscript, "Investing in Artificial General Intelligence," for consideration at [Journal].
...
[Optional journal-specific fit paragraph.]
